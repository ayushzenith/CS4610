...
def main():
    ...
    # new_x, new_y = ca.pixel_space_to_robot_frame(229, 137)  
    # print(new_x, new_y)  
    ...
    bot.arm.set_ee_pose_components(x=0.5, y = -0.2, z=0.2, moving_time=2)
    bot.arm.set_ee_pose_components(x=0.5, y = -0.2,  z=0.09, moving_time=2)
    bot.arm.set_ee_pose_components(x=0.5, y = -0.2,  z=0.2, moving_time=2)
    ...
    # bot.arm.set_ee_pose_components(x=0.478, y=0.119, z=0.2, moving_time=2)
    # bot.arm.set_ee_pose_components(x=0.478, y=0.119, z=0.07, moving_time=2)
    # bot.arm.set_ee_pose_components(x=0.478, y=0.119, z=0.2, moving_time=2)
